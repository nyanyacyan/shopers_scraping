...
class SingleItemScraper:
    ...
    def single_item_scraper(self, search_field_xpath, search_word, search_buttan_xpath, showcase_box_xpath, jump_link_xpath, price_xpath):
        '''
        ...
        # 同期メソッドを非同期処理に変換
    async def single_item_scraper_async(self, search_field_xpath, search_word, search_buttan_xpath, showcase_box_xpath, jump_link_xpath, price_xpath):
